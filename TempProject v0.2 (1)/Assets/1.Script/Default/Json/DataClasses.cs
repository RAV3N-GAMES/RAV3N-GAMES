...
public static class Data_Player
{
    ...
    public static void addGold(int add_g) { gold += add_g; Debug.Log("gold : " + Data_Player.gold); }
    public static void addFame(int add_f) { fame += add_f;  }
    public static void subGold(int sub_g) { gold -= sub_g; Debug.Log("gold : " + Data_Player.gold); }
