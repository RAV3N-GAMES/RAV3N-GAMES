...
// Use this for initialization
    void Awake () {
        ...
        {
            Debug.Log(i + "th index: " + Tbl_SecretSetup[i].id + " " + Tbl_SecretSetup[i].Level + " " + Tbl_SecretSetup[i].Fame + " " + Tbl_SecretSetup[i].SecretBanditsGenChance+ " " + Tbl_SecretSetup[i].Price+ " " + Tbl_SecretSetup[i].Type);
        }
    }
